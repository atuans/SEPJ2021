							   ...
							   %>
                                <tr>
                                    <td class="thumbnail-img">
                                        <a href="#">
									<img class="img-fluid" src="images/Clothing/<%=p.getProductPhoto() %>" alt="" />
								</a>
                                    </td>
                                    <td class="name-pr">
                                        <a href="#">
                                    ...
                                    <td class="price-pr">
                                        <p><%=p.getProductPrice() %>:VND</p>
                                    </td>
                                    <td class="quantity-box"><input type="number" size="4" value="<%=c.getQuantity() %>" min="0" step="1" class="c-input-text qty text"></td>
                                    <td class="total-pr">
   										 <p style="font-size:17px;"><%=c.getPrice() %>VND</p> 
                                    </td>
                                    <td class="remove-pr">
                                       <a href="CartController?cartId=<%=c.getCartId()%>&action=delete"><button type="button" class="btn btn-danger">Remove</button>
                ...
                <div class="col-lg-4 col-sm-12">
                    <div class="order-box">
                        ...
                        <div class="d-flex gr-total">
                            <h5>Grand Total</h5>
                            <div class="ml-auto h5"> <%= new CartDaoImp().totalPriceFromCart(user.getUserId()) %> </div>
                        </div>
                        <hr> </div>
                </div>
