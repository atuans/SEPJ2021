            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                        ...
                        %>
                                <div class="rounded p-2 bg-light">
                                    <div class="media mb-2 border-bottom">
                                            <div class="small text-muted">Price: <%=rs.getString(6) %><span class="mx-2">|</span> Quantity: <%=rs.getString(5) %> <span class="mx-2">|</span> Size: <%=rs.getString(4) %></div>
                                        </div>
                                    </div>
	                ...
	                %>
                        ...
                        <div class="col-12 d-flex shopping-box"> <a href="Bill.jsp" class="ml-auto btn hvr-hover">Place Order</a> </div>
                    </div>
                </div>
            </div>
