...
public class CartController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			BEAN.User user=(User)session.getAttribute("active-user");
			...
			int price=ContactDAO.getProductSellingPrice(productPrice, productDiscount);
			...
			if(check==false)
			{
			    ...
			    if(flag==true)
			    {
			    	session.setAttribute("message","Product Added to Cart Successfully, Quantity increase..!");
			        response.sendRedirect("index.jsp?message=exist");
			    }
