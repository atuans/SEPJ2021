...
public class ProductController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equals("delete"))
		{
			...
			File f=new File("/Users/anhtuan1312/eclipse-workspace/Shopping-2.0/src/main/webapp/images/Clothing"+productImage);
		...
		{
			int categoryId=Integer.parseInt(request.getParameter("productId"));
			...
			if(totalProduct>0)
			{
			    ...
			    {
			    	  File f=new File("/Users/anhtuan1312/eclipse-workspace/Shopping-2.0/src/main/webapp/images/Clothing"+p.getProductPhoto());
					  f.delete();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else if(action.equals("addProduct"))
		{
			...
			String uploadPath="/Users/anhtuan1312/eclipse-workspace/Shopping-2.0/src/main/webapp/images/Clothing";
		...
		else if(action.equals("updateProduct"))
		{
			...
			String uploadPath="/Users/anhtuan1312/eclipse-workspace/Shopping-2.0/src/main/webapp/images"+fileName;
