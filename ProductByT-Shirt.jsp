...
<%--                                     <a class="list-group-item list-group-item-action" href="shop.jsp?bId=<%=new ProductDaoImp().getProductByCategory(b.getBrandId()) %>" data-toggle="collapse" aria-expanded="true" aria-controls="sub-men1"><%=b.getBrandTitle() %>  </a>
 --%>                                   <a href="ProductByT-Shirt.jsp?category=<%= b.getBrandId() %>"><%=b.getBrandTitle() %> </a>
                ...
                <div class="col-xl-9 col-lg-9 col-sm-12 col-xs-12 shop-content-right">
                    <div class="right-product-box">
						...
						List<Product> listOfProducts = new ProductDaoImp().getAllProduct();
