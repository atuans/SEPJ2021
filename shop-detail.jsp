	...
	{%>
		<div aria-live="polite" aria-atomic="true" style="position: relative; min-height: 200px;">
		  <div class="toast" style="position: absolute; top: 0; right: 0;">
		    ...
		    <div class="toast-body">
		      Product Already Exist in your cart, quantity increase
		    </div>
		  </div>
		</div>
            ...
            <div class="row">
                <div class="col-xl-5 col-lg-5 col-md-6">
                    <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active"> <img class="d-block w-100" src="images/Clothing/<%=product.getProductPhoto() %>" alt="First slide"> </div>
                        </div>
                ...
                <div class="col-xl-7 col-lg-7 col-md-6">
                    <div class="single-product-details">
                        ...
                        <h5> <del><%=product.getProductDiscount() %></del> <%=product.getProductPrice() %></h5>
                        <p class="available-stock"><span> Available:<%=product.getProductQuantity()  %> </span>
                            <p>
                                <h4>Short Description:</h4>
                                <p>
                                    <%=product.getProductDescription() %> </p>
                        <%
                                   if(u==null)
                                   {
                               %>
                               ...
                               <form class="form-inline" onclick="return checkUser()">
                                  ...
                                  <button type="submit" class="btn custom-bg text-dark mb-2">Add To Cart</button>
                               </form>
                              ...
                              %> 
                                       <%
                                           ...
                                           {
                                       %>
                                      <a href="ProductController?productId=<%=request.getParameter("productId")%>&action=delete"><button type="button" class="btn btn-danger">Delete Product</button></a>
                                      ...
                                      <%
                                           ...
                                           {
                                      %>
                                               <form class="form-inline" onclick="return checkUser()" action="CartController" method="post">
                                               ...
                                               <input type="submit" class="btn custom-bg text-dark mb-2" value="Add To Cart">
                              ...
                              <%-- <form onclick="return checkUser()" action="CartController" method="POST">
                                <input type="hidden" name="action" value="addToCart">
                                   <input type="hidden" name="productId" value="<%=productId%>">
